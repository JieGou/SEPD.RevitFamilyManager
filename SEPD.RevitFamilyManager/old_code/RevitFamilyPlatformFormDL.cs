...
namespace SEPD.RevitFamilyManager
{
    public partial class RevitFamilyManagerFormDL : System.Windows.Forms.Form
    {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtr = new DataTable("dtr");
            try
            {
        ...
        private void btn_justLoadRfa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ModuleTestPart ModuleTestPart1 = new ModuleTestPart();
                ModuleTestPart1.familyFilePaths = downloadFamilyLocsA;
                ModuleTestPart1.parameterFilePaths = downloadXlsLocsA;
                ModuleTestPart1.LoadTag = LoadTag;
                ModuleTestPart1.ModuleTestPart1(commandData);
        ...
        private void lbl_pervPage_Click(object sender, EventArgs e)
        {
            ...
            //    lbl_currentPage.Text = currentPage.ToString();//当前页
            //    lbl_pageCount.Text = pageCount.ToString();//总页数
            //    lbl_recordCount.Text = recordCount.ToString();//总记录数
            //}
        ...
        ///// 针对移交标准进行自动载入命名
        ///// </summary>
        ///// <param name="downloadFamilyLoc"></param>
        ///// <returns></returns>
        //private string downloadName(string downloadFamilyLoc)
        //{
        ...
        //    //switch (dtInfo.Rows[0]["f_Cat"].ToString())
        //    //{
        //    //    case "e": fileNameCat = ; break;
        //    //}
        //    //switch (dtInfo.Rows[0]["f_ValLevel"].ToString())
        //    //{
        //    //    case "e": fileNameLevel =  "V10"; break;
        //    //}
        //    //switch (dtInfo.Rows[0]["f_DeviceType"].ToString())
        //    //{
        //    //    case "e": fileNameType =  ; break;
        //    //}
        //    //switch (dtInfo.Rows[0]["f_manufacturer"].ToString())
        //    //{
        //    //    case "e": fileNameProd = 　; break;
        //    //}
 
        //    finalFileName = fileNameCat + fileNameLevel + fileNameType + fileNameProd;
