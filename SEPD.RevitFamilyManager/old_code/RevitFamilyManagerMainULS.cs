...
namespace SEPD.RevitFamilyManager
{
    ...
    public class RevitFamilyManagerMainULS : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            RevitFamilyManagerFormULS RevitFamilyManagerFormULS = new RevitFamilyManagerFormULS();
            ...
            RevitFamilyManagerFormULS.Show();
